...
export default class Top5Model {
    ...
    moveItem(oldIndex, newIndex) {
        ...
        let temp = this.currentList.items[newIndex];
        console.log(this.currentList.items[newIndex]);
        console.log(this.currentList.items[oldIndex]);
        this.currentList.items[newIndex] = this.currentList.items[oldIndex];
        this.currentList.items[oldIndex] = temp;
        console.log("after")
        console.log(this.currentList.items[newIndex]);
        console.log(this.currentList.items[oldIndex]);
        this.view.update(this.currentList);
